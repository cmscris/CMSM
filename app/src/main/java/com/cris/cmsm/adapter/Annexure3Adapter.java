...
public class Annexure3Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;
    private static final int TYPE_FOOTER = 2;
    List<Annexure3vo> list;
    Context context;
    ReportHeaderView reportHeaderView;
    private String date;

    public Annexure3Adapter(Context context, ReportHeaderView reportHeaderView, List<Annexure3vo> list) {
    ...
    private Annexure3vo getItem(int position) {
