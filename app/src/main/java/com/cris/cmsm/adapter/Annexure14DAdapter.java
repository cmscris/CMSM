...
public class Annexure14DAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;
    private static final int TYPE_FOOTER = 2;
    List<Annexure14dvo> list;
    Context context;
    ReportHeaderView reportHeaderView;
    private String date;

    public Annexure14DAdapter(Context context, ReportHeaderView reportHeaderView, List<Annexure14dvo> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof VHItem) {
            int pos = position - 1;
            Annexure14dvo model = getItem(pos);
            ...
            if (model.getSebname().equalsIgnoreCase("~"))
    ...
    private Annexure14dvo getItem(int position) {
