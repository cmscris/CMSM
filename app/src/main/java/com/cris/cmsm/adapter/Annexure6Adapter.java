...
public class Annexure6Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;
    private static final int TYPE_FOOTER = 2;
    List<Annexure6Report> list;
    Context context;
    ReportHeaderView reportHeaderView;
    private String date;

    public Annexure6Adapter(Context context, ReportHeaderView reportHeaderView, List<Annexure6Report> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof VHItem) {
            int pos = position - 1;
            Annexure6Report model = getItem(pos);
    ...
    private Annexure6Report getItem(int position) {
