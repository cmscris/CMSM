...
public class Annexure14CAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;
    private static final int TYPE_FOOTER = 2;
    List<Annexure14cvo> list;
    Context context;
    ReportHeaderView reportHeaderView;
    private String date;

    public Annexure14CAdapter(Context context, ReportHeaderView reportHeaderView, List<Annexure14cvo> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof VHItem) {
            int pos = position - 1;
            Annexure14cvo model = getItem(pos);
            ((VHItem) holder).tv_railway.setText(model.getFinYear());
    ...
    private Annexure14cvo getItem(int position) {
