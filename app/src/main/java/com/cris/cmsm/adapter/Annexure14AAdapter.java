...
public class Annexure14AAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private static final int TYPE_HEADER = 0;
    private static final int TYPE_ITEM = 1;
    private static final int TYPE_FOOTER = 2;
    List<Annexure14AReport> list;
    Context context;
    ReportHeaderView reportHeaderView;
    private String date;

    public Annexure14AAdapter(Context context, ReportHeaderView reportHeaderView, List<Annexure14AReport> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof VHItem) {
            int pos = position - 1;
            Annexure14AReport model = getItem(pos);
            ...
            if (pos > 0) {
                if (model.getRailway().equals("~") && model.getSebName().equals("~")) {
                    ((VHItem) holder).tv_railway.setText("GRAND TOTAL");
                } else if (model.getSebName().equals("~")) {
    ...
    private Annexure14AReport getItem(int position) {
