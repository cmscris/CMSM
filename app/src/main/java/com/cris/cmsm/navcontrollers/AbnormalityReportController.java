...
public class AbnormalityReportController extends AppCompatActivity implements OnItemClickListener, ResponseView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        insertRequestPresenter = new InsertRequestPresenter(AbnormalityReportController.this);
        commonClass = new CommonClass(AbnormalityReportController.this);
        ...
        if (abnormalityResponse != null && abnormalityResponse.getAbnormalityResponseVO() != null) {
            ...
            AbnormalityResponseVO cvo = new AbnormalityResponseVO();
            cvo.setLocation(hq_str);
            ...
            list.add(0, cvo);
            recyclerView.setAdapter(new AbnormalityAdapter(AbnormalityReportController.this, reportHeaderView, AbnormalityReportController.this, list));
        }
    }
            ...
            if (object != null && object instanceof SubStationRes) {
                ...
                if (!TextUtils.isEmpty(model.getMessage()) && model.getMessage().equalsIgnoreCase("Success")) {
                    if (model.getSubstationResponseVO() != null && model.getSubstationResponseVO().size() > 0) {
                        ...
                        CommonClass.goToNextScreen(AbnormalityReportController.this, DetailSSConsumption.class, true, substationResponseVO.getAssetname(), null);
                    }
                }
            }
        } catch (Exception e) {
