...
public class AbnormalityController extends BaseActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener, ResponseView {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        monthlyRequestPresenter = new MonthlyRequestPresenter(AbnormalityController.this);
        requestPresenter = new RequestPresenter(AbnormalityController.this);
        loginUser = new UserLoginPreferences(AbnormalityController.this).getLoginUser();
        userLoginPreferences = new UserLoginPreferences(AbnormalityController.this);
        loginInfoModel = userLoginPreferences.getLoginUser();
        commonClass = new CommonClass(AbnormalityController.this);
        dataBaseManager = new DataBaseManager(AbnormalityController.this);
        dataBaseManager.createDatabase();

        font = new FontFamily(AbnormalityController.this).getBold();
        ...
        spn_ryCode.setAdapter(new RailwayAdapter(AbnormalityController.this, railwayList));
        spn_divCode.setAdapter(new DivisonAdapter(AbnormalityController.this, dataBaseManager.getDivisionList("-100")));
        ...
        spn_lobbyCode.setAdapter(new LobbyAdapter(AbnormalityController.this, lobby_list_tmp));
        spn_month.setAdapter(new MonthAdapter(AbnormalityController.this, CommonClass.getMonthList()));
        spn_fYear.setAdapter(new SpinnerAdapter(AbnormalityController.this, CommonClass.getYear()));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_filter:
                ...
                {
                    if (CommonClass.checkInternetConnection(AbnormalityController.this)) {
                        callWebService(Constants.ABNORMALITY);
                    } else {
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (object instanceof Railway) {
            ...
            spn_divCode.setAdapter(new DivisonAdapter(AbnormalityController.this, list));
            ...
            if (!TextUtils.isEmpty(loginUser.getAuthlevel()) && (loginUser.getAuthlevel().equalsIgnoreCase(Constants.AUTH_BOARD)
                ...
                spn_divCode.setAdapter(new DivisonAdapter(AbnormalityController.this, divisionList));
    ...
    private void callWebService(int cat) {
        try {
            ...
            if(cat == Constants.ABNORMALITY)
            {
                ...
                monthlyRequestPresenter.Request(request, "Getting Abnormality Report", Constants.ABNORMALITY);
    ...
    public void ResponseOk(Object object, int position) {
        switch (position) {
            ...
            case Constants.LOBBY_LIST:
                ...
                spn_lobbyCode.setAdapter(new LobbyAdapter(AbnormalityController.this, lobby_list));
            ...
            case Constants.ABNORMALITY:
                AbnormalityResponse abnormalityResponse = (AbnormalityResponse) object;
                if (abnormalityResponse != null && abnormalityResponse.getAbnormalityResponseVO() != null) {
                    DataHolder.getInstance().setAbnormalityResponse(abnormalityResponse);
                    CommonClass.goToNextScreen(AbnormalityController.this, AbnormalityReportController.class, false, false);
                } else
